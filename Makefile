...
PROJECT_SRC := "packages/src/sparv-sbx-sentence-emotional-classification-kb-emoclass"
...
all_tests := packages/src/sparv-sbx-sentence-emotional-classification-kb-emoclass/tests
tests := packages/src/sparv-sbx-sentence-emotional-classification-kb-emoclass/tests
